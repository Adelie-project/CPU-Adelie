main:
  ...
  addi r5, r0, $20  ; fib_rec(20) を呼びたい
...
fib_rec_bge1:
  ...
  addi r4, r0, $1   ; pc_interval=1によるずれ
  beq r0, r0, fib_rec_ret ; go back
  addi r0, r0, $0   ; pc_interval=1によるずれ
finish:
  addi r0, r0, $0   ; 終了
...
fib[32] = 2178309 = 0x213d05 <- シミュレータで3秒
fib[33] = 3524578 = 0x35c7e2
fib[34] = 5702887 = 0x5704e7
fib[35] = 9227465 = 0x8cccc9 <- シミュレータで10秒
